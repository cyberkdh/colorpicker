...
namespace DHColorPicker {
	// MFC IDD_ABOUTBOX port — 237x96 DLU
	...
	public class AboutForm : Form {
		...
		// Builds and arranges all controls for the About dialog
		// About 다이얼로그의 모든 컨트롤을 생성하고 배치
		private void InitializeComponent() {
			this.SuspendLayout();

			// Logo bitmap (MFC: IDB_BM_LOGO1, 7,7,80,82 DLU)
			// 로고 비트맵 (MFC: IDB_BM_LOGO1, 7,7,80,82 DLU)
